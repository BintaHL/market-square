    ...
    return (
        <div className="">
            <div className="max-w-[80%] mx-auto">
                <div className="grid grid-cols-2 justify-between gap-40">

                    {/* left Menu */}
                    <div className="flex items-start gap-20">
                        <div className="min-w-[50%] flex flex-col gap-5 sticky top-30">
                            <div className="flex items-start justify-start text-sm gap-4 shrink-0 whitespace-nowrap mb-5">
                        ...
                        {/* Right Form */}
                        <div className="flex flex-col  gap-3 my-30 w-full ">
                            <form>
