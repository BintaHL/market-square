        ...
        <div className="w-full">
            <div className="max-w-[80%] mx-auto">
                <div className="flex items-center text-sm gap-2 mb-5 whitespace-nowrap mt-30">
                    <h6 className="text-dark-muted">Home</h6><span>/</span>
                    <h6>My Account</h6>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-[1fr_2fr] lg:grid-cols-[2fr_2fr] gap-5 lg:gap-10 items-start">
                        ...
                        <form className="w-full">
                            ...
                            <div className="grid gap-6 w-full">
                                ...
                                <div className="flex items-center gap-2 min-w-0  ">
                                    <input type="checkbox" name="" className="w-5 h-5  accent-primary rounded" />
                                    <p className="text-md"> save this information for faster checkout next time</p>
                                </div>
                            </div>
                        </form>
                    </main>
                    ...
                    <div className="mt-40">
                        ...
                        {/* Place Order */}
                        <Button href="" className="mt-6"> Place Order</Button>
                    </div>
