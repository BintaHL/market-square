    ...
    return (
        <main>
            <div ref={dropdownRef} className="">
                {/* TRIGGER BUTTON */}
                <div className="flex items-end justify-end m-10 relative">
                    ...
                    <button
                        ...
                        className="rounded-full p-1.5 bg-card-bg text-gray-500 hover:bg-gray-100 hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-dark-muted focus:ring-offset-2 transition-colors duration-200"
                    >
                        <RxAvatar size={20} />
                    </button>
                </div>
                ...
                {/* DROPDOWN MENU */}
                {isOpen && (
                    <div className="absolute top-18 right-10 z-50 mt-2 w-56 origin-top-right rounded-xl bg-white p-1 shadow-lg ring-1 ring-black/5 focus:outline-none">
                        ...
                        <div className="py-1">
                            <Link href="/account" onClick={() => setIsOpen(false)} className="flex items-center gap-2 rounded-lg px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 hover:text-gray-900">
