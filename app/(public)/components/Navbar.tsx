  ...
  return (
    <div className='fixed w-full left-0 top-0 z-100'>
        <div className='z-100 shadow-md bg-white'>
            ...
            <div className='w-full bg-[#000000] py-3'>
                <div className=''>
                ...
                <div className='container mx-auto flex flex-col md:flex-row items-center py-5 md:py-8 gap-20 justify-between'>
                    ...
                    <div className='flex flex-col md:flex-row justify-between md:gap-40 bg-white'>
                        <div className='flex flex-col md:flex-row mx-auto'>
                            <Link href="/" className='mb-5 md:pr-6 hover:underline hover:decoration-mist-400 hover:decoration-2 hover:underline-offset-4 cursor-pointer text-2xl md:text-[15px]'>Home</Link>
                            <Link href="/contact" className='mb-5 md:pr-6 hover:underline hover:decoration-mist-400 hover:decoration-2 hover:underline-offset-4 cursor-pointer text-2xl md:text-[15px]'>Contact</Link>
                            <Link href="/about" className='mb-5 md:pr-6 hover:underline hover:decoration-mist-400 hover:decoration-2 hover:underline-offset-4 cursor-pointer text-2xl md:text-[15px]'>About</Link>
                            <Link href="/auth/signin" className='mb-5 md:pr-6 hover:underline hover:decoration-mist-400 hover:decoration-2 hover:underline-offset-4 cursor-pointer text-2xl md:text-[15px] whitespace-nowrap'>Sign Up</Link>
                        </div>
