...
export function ProfileDropdownCustom() {
  ...
  return (
    <div ref={dropdownRef} className="relative inline-block text-left">
      ...
      {isOpen && (
        <div className="absolute h-70 right-0 top-full z-[200] mt-2 w-64 origin-top-right overflow-hidden rounded-xl border border-gray-200 bg-white shadow-lg ring-1 ring-black/5">
