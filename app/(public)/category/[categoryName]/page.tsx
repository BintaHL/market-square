...
// 1. Define TypeScript Types based on FakeStoreAPI structure
interface Rating {
  rate: number;
  count: number;
}
...
// 2. Fetch function targeting the explicit category endpoint
async function getProductsByCategory(categorySlug: string): Promise<Product[]> {
  // Decode the URL slug (handles spaces like %20 in "men's clothing")
