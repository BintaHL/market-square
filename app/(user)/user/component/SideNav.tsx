"use client"
import { CirclePlus, LogOut, PackageSearch, ShoppingCart, Users, Users2 } from "lucide-react"
      ...
      <div className="mt-10 flex flex-col gap-10">
        ...
        <div className="flex flex-col justify-between gap-40">
          <div className="flex flex-col gap-6">
            ...
            >
               <Users  className="w-6 h-6" />Sellers Information
            </Link>
            <Link
            ...
            >
              <CirclePlus className="w-6 h-6" />Add New Sellers
            </Link>
            <Link
              href="#"
